...
-- Dumping data for table resto_sate.orders: ~9 rows (approximately)
...
CREATE TABLE IF NOT EXISTS `order_items` (
  ...
  CONSTRAINT `order_items_ibfk_2` FOREIGN KEY (`recipe_id`) REFERENCES `recipes` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=31 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

-- Dumping data for table resto_sate.order_items: ~24 rows (approximately)
...
-- Dumping data for table resto_sate.tables: ~6 rows (approximately)
...
INSERT INTO `users` (`id`, `username`, `password`, `role`, `picture`) VALUES
	...
	('WA00001', 'waiter', '$2y$10$v9WwaIoypE5VbxMjqiCiMuu4otI5b9ek5R2CJ6KRiSREYtSWTM0p6', 'waiter', 'image/52a877a5885df5faa8b2a5a4991d921b.jpg');
